...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    title="Mark - Black"
    forceDownload
    previewSrc="/logo/Mark/Large/PREVIEW-Nimbus-Mark-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Mark/Large/Nimbus-Mark-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Mark/Large/Nimbus-Mark-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    title="Mark - White"
    forceDownload
    previewSrc="/logo/Mark/Large/PREVIEW-Nimbus-Mark-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Mark/Large/Nimbus-Mark-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Mark/Large/Nimbus-Mark-White-Large.svg"
      }
    ]}
  />
</div>
...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/Large/PREVIEW-Nimbus-Vertical lockup-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Large/Nimbus-Vertical lockup-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Large/Nimbus-Vertical lockup-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/Large/PREVIEW-Nimbus-Vertical lockup-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Large/Nimbus-Vertical lockup-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Large/Nimbus-Vertical lockup-White-Large.svg"
      }
    ]}
  />
</div>
...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Horizontal lockup/Large/PREVIEW-Nimbus-Horizontal lockup-Black-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Horizontal lockup/Large/Nimbus-Horizontal lockup-Black-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Horizontal lockup/Large/Nimbus-Horizontal lockup-Black-Large.svg"
      }
    ]}
  />
  ...
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Horizontal lockup/Large/PREVIEW-Nimbus-Horizontal lockup-White-Large.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Horizontal lockup/Large/Nimbus-Horizontal lockup-White-Large.png"
      },
      {
        title: "SVG",
        src: "/logo/Horizontal lockup/Large/Nimbus-Horizontal lockup-White-Large.svg"
      }
    ]}
  />
</div>
